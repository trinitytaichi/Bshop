         ...
         <div class="control-group">
           <div class="controls">
             <div class="input-prepend">
              ...
              <input type="text" name="useridLog" id="useridLog" class="span3 required" placeholder="UserID使用者帳號" value="" />   
             </div> 
           </div>
         </div>
         <div class="control-group">
           <div class="controls">   
             <div class="input-prepend">                          
              ...
              <input type="password" name="passwordLog" id="passwordLog" class="span3 required" placeholder="Password密碼" value="" />
            </div>
          </div>                      
        </div>                                                
       <button type="submit" class="btn submit_login"><i class="icon icon-black icon-unlocked"></i> Login登入</button>
    </form> 
    <!-- /LOGIN form -->  
   </div>                           
</div> <!-- /CONTAINER -->
